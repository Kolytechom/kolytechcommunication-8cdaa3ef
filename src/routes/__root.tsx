...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "KolyTech Communications — ICT, CCTV, Solar & Healthcare IT" },
      { name: "description", content: "KolyTech Communications delivers enterprise-grade IT infrastructure, CCTV, hardware, software, cloud and solar power installations across Nigeria." },
      { property: "og:description", content: "KolyTech Communications delivers enterprise-grade IT infrastructure, CCTV, hardware, software, cloud and solar power installations across Nigeria." },
      { name: "twitter:description", content: "KolyTech Communications delivers enterprise-grade IT infrastructure, CCTV, hardware, software, cloud and solar power installations across Nigeria." },
